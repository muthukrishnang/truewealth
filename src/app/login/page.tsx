    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm rounded-2xl border border-slate-700/50 bg-slate-800/50 p-8 shadow-xl">
        ...
        <button
          ...
          className="mt-8 flex w-full items-center justify-center gap-3 rounded-xl border border-slate-600 bg-white py-3 font-medium text-slate-800 hover:bg-slate-50"
        >
